...
@keyframes animatebottom { 
  ...
  <script type="text/javascript">
    ...
    function saveTextAsFile() {
      ...
      var fileNameToSaveAs = "output.bio";
...
<body>
<h1 id="head"> Feature Library Mechanism</h1>
...
<form id="feature" action="/clew/feature_library/result" method="post" enctype="multipart/form-data">
  ...
  <p>Select the Features for tokens on the right to be included:</p>
    ...
    %end
  <br><br>
  <button type="submit" id="execute" onclick="preloader();">Execute Feature Library</button> <div class="popup" onclick="myFunction()">Description
...
<div class="display">
  ...
  <!-- <a href="/feature_library/change_plot">Change the order of the process</a> -->
</div>
<div>
  <!-- <form action="/feature_library/download/{{output}}"> -->
    <p>The BIO generated is displayed as follows:</p>
    <textarea name="bio" id="content" rows="20" cols="200"> {{bio}} </textarea>
    <button type="button" value="Download" id="save" onclick="saveTextAsFile();">Download BIO File</button>
  <!-- </form> -->
