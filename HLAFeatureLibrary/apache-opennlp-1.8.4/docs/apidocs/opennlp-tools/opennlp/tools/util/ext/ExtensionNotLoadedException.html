...
<title>ExtensionNotLoadedException (Apache OpenNLP Tools 1.8.4 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="ExtensionNotLoadedException (Apache OpenNLP Tools 1.8.4 API)";
        }
    }
    catch(err) {
    }
...
<div class="subNav">
<ul class="navList">
<li><a href="../../../../opennlp/tools/util/ext/ExtensionLoader.html" title="class in opennlp.tools.util.ext"><span class="typeNameLink">Prev&nbsp;Class</span></a></li>
<li><a href="../../../../opennlp/tools/util/ext/ExtensionServiceKeys.html" title="class in opennlp.tools.util.ext"><span class="typeNameLink">Next&nbsp;Class</span></a></li>
</ul>
<ul class="navList">
<li><a href="../../../../index.html?opennlp/tools/util/ext/ExtensionNotLoadedException.html" target="_top">Frames</a></li>
...
<!-- ======== START OF CLASS DATA ======== -->
<div class="header">
<div class="subTitle">opennlp.tools.util.ext</div>
<h2 title="Class ExtensionNotLoadedException" class="title">Class ExtensionNotLoadedException</h2>
</div>
...
<li>
<ul class="inheritance">
<li>opennlp.tools.util.ext.ExtensionNotLoadedException</li>
</ul>
</li>
</ul>
</li>
...
<hr>
<br>
<pre>public class <span class="typeNameLabel">ExtensionNotLoadedException</span>
...
<dd><a href="../../../../serialized-form.html#opennlp.tools.util.ext.ExtensionNotLoadedException">Serialized Form</a></dd>
</dl>
</li>
</ul>
</div>
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../../../opennlp/tools/util/ext/ExtensionNotLoadedException.html#ExtensionNotLoadedException-java.lang.String-">ExtensionNotLoadedException</a></span>(<a href="http://docs.oracle.com/javase/8/docs/api/java/lang/String.html?is-external=true" title="class or interface in java.lang">String</a>&nbsp;message)</code>&nbsp;</td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../../../opennlp/tools/util/ext/ExtensionNotLoadedException.html#ExtensionNotLoadedException-java.lang.Throwable-">ExtensionNotLoadedException</a></span>(<a href="http://docs.oracle.com/javase/8/docs/api/java/lang/Throwable.html?is-external=true" title="class or interface in java.lang">Throwable</a>&nbsp;t)</code>&nbsp;</td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a href="../../../../opennlp/tools/util/ext/ExtensionNotLoadedException.html#isOSGiEnvironment--">isOSGiEnvironment</a></span>()</code>
<div class="block">Indicates if OpenNLP is running in an OSGi environment or not.</div>
</td>
</tr>
</table>
<ul class="blockList">
...
<a name="ExtensionNotLoadedException-java.lang.String-">
<!--   -->
</a>
<ul class="blockList">
<li class="blockList">
<h4>ExtensionNotLoadedException</h4>
<pre>public&nbsp;ExtensionNotLoadedException(<a href="http://docs.oracle.com/javase/8/docs/api/java/lang/String.html?is-external=true" title="class or interface in java.lang">String</a>&nbsp;message)</pre>
</li>
</ul>
<a name="ExtensionNotLoadedException-java.lang.Throwable-">
<!--   -->
</a>
<ul class="blockListLast">
<li class="blockList">
<h4>ExtensionNotLoadedException</h4>
<pre>public&nbsp;ExtensionNotLoadedException(<a href="http://docs.oracle.com/javase/8/docs/api/java/lang/Throwable.html?is-external=true" title="class or interface in java.lang">Throwable</a>&nbsp;t)</pre>
</li>
</ul>
</li>
</ul>
...
<h3>Method Detail</h3>
<a name="isOSGiEnvironment--">
<!--   -->
</a>
<ul class="blockListLast">
<li class="blockList">
<h4>isOSGiEnvironment</h4>
<pre>public&nbsp;boolean&nbsp;isOSGiEnvironment()</pre>
<div class="block">Indicates if OpenNLP is running in an OSGi environment or not.</div>
<dl>
<dt><span class="returnLabel">Returns:</span></dt>
<dd>true if running in an OSGi environment</dd>
</dl>
</li>
</ul>
</li>
