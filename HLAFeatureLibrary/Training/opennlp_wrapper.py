...
class OpenNLP:
    ...
    def parse(self, text):
        ...
        # output = subprocess.run(argument, stdin=text, stdout=subprocess.PIPE).stdout.decode('utf-8')
        print(argument)
        ...
        output = output
        # output = subprocess.check_output(argument, universal_newlines=True, input=text)
        return output
