 ...
 * @generated */
public class Age extends TemporalFeature {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Age.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Age() {/* intentionally empty block */}
   ...
   */
  public Age(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Age(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
