...
import copy
from PostTokenizer_GATE import parse_hyphen, find_tokens
import re

'''
This file implements the PostTokenizer tool for OpenNLP Tokenizer which 
...
Usage: python PostTokenizer_OpenNLP.py input_lif_file input_ann_file output_lif_file
'''
            ...
            for word in new_words:
                if word != '':
                    ...
                    if start != end:
                        ...
                        hyphen_ann['end'] = str(start)
                        update_annotations.append(hyphen_ann)
            #print('Splitted forward-slash between the word', end=' ')
